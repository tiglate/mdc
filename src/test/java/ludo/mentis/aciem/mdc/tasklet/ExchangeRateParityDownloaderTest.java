...
class ExchangeRateParityDownloaderTest {
    ...
    private ExchangeRateParityDownloader tasklet;
    ...
    void execute_shouldDownloadFileAndPopulateJobContext() throws Exception {
        // Given
        var expectedFileName = referenceDate.format(DateTimeFormatter.ofPattern("yyyyMMdd")) + ".csv";
    ...
    void constructor_shouldUseCurrentDate_whenReferenceDateIsNull() {
        ...
        // When
        tasklet = new ExchangeRateParityDownloader(fileDownloadService, null, baseUrl);
        ...
        try {
            ...
            var expectedPrefix = today.format(DateTimeFormatter.ofPattern("yyyyMMdd"));
    ...
    void execute_shouldUseCorrectUrlFormat() throws Exception {
        ...
        tasklet = new ExchangeRateParityDownloader(fileDownloadService, testDate, baseUrl);

        var expectedFileName = testDate.format(DateTimeFormatter.ofPattern("yyyyMMdd")) + ".csv";
        var expectedUrl = baseUrl + expectedFileName;
    ...
    void execute_shouldHandleBaseUrlWithTrailingSlash() throws Exception {
        ...
        tasklet = new ExchangeRateParityDownloader(fileDownloadService, referenceDate, baseUrlWithSlash);
